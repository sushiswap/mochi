...
contract MochiMol is ReentrancyGuard {
    ...
    ***************/
    ...
    address payable public immutable suChef; // sushi minion contract reference
    ...
    constructor(
        ...
        SuChef minion = new SuChef(_approvedTokens[0], IMolMinimal(address(this))); // summon sushi minion contract 
        suChef = address(minion); // record minion reference
